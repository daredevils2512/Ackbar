...
const char* Robot::logFileName = "log.txt";
FILE *Robot::logFile = NULL;
void Robot::Log(string message) {
	if (logFile == NULL) {
		logFile = fopen(logFileName, "a");
	}
	if (prefs->GetBoolean("Log", true)) {
		fprintf(logFile, "%f %s\n", Timer::GetFPGATimestamp(), message.c_str());
	}
}
void Robot::ClearLog() {
	if (logFile != NULL) {
...
void Robot::TeleopPeriodic() {
	...
	SmartDashboard::PutBoolean("EnoughPressure",
			Robot::compressorSubsystem->Pressurized());
