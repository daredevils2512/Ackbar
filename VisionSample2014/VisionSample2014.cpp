...
bool VisionSample2014::ProcessImage(void) {
	...
	Threshold threshold(97, 124, 150, 255, 92, 255); //HSV threshold criteria, ranges are in that order ie. Hue is 60-100
	...
	if (reports->size() > 0) {
		...
		target.totalScore = target.leftScore = target.rightScore
				= target.tapeWidthScore = target.verticalScore = 0;
 ...
 */
double VisionSample2014::ComputeDistance(BinaryImage *image,
 ...
 */
double VisionSample2014::ScoreAspectRatio(BinaryImage *image,
