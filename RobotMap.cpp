...
Relay* RobotMap::robotCompressorCompressorSpike = NULL;
...
void RobotMap::init() {
	...
	lightsClawLeds = new Relay(1, 2);
	lw->AddActuator("Lights", "ClawLeds", lightsClawLeds);
	
	robotCompressorCompressorSpike = new Relay(1, 1);
	lw->AddActuator("RobotCompressor", "CompressorSpike", robotCompressorCompressorSpike);
