...
void RobotMap::init() {
	...
	lw->AddActuator("CompressorSubsystem", "CompressorSpike",
			compressorSubsystemCompressorSpike);

	compressorSubsystemCompressorPressureSwitch = new DigitalInput(1, 7);
	lw->AddSensor("CompressorSubsystem", "CompressorPressureSwitch",
			compressorSubsystemCompressorPressureSwitch);
